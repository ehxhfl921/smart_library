...
<html>
<head>
	<title>Smart Library Privacy Policy</title>
...
<main>
	...
	<div class="policyBox">
		<div class="logoBox">
			<img alt="스마트 도서관" src="${path}/resources/logo_shadow.png">
		</div>
	<h2>개인정보처리방침</h2>
	
	<div class="policyIndex">
		<a href="#target1">• 제1조(목적)</a>
		<a href="#target2">• 제2조(개인정보 처리의 원칙)</a>
		<a href="#target3">• 제3조(본 방침의 공개)</a>
		<a href="#target4">• 제4조(본 방침의 변경)</a>
		<a href="#target5">• 제5조(회원 가입을 위한 정보)</a>
		<a href="#target6">• 제6조(본인 인증을 위한 정보)</a>
		<a href="#target7">• 제7조(개인정보 수집 방법)</a>
		<a href="#target8">• 제8조(개인정보의 이용)</a>
		<a href="#target9">• 제9조(개인정보의 보유 및 이용기간)</a>
		<a href="#target10">• 제10조(법령에 따른 개인정보의 보유 및 이용기간)</a>
		<a href="#target11">• 제11조(개인정보의 파기원칙)</a>
		<a href="#target12">• 제12조(개인정보파기절차)</a>
		<a href="#target13">• 제13조(개인정보파기방법)</a>
		<a href="#target14">• 제14조(광고성 정보의 전송 조치)</a>
		<a href="#target15">• 제15조(아동의 개인정보보호)</a>
		<a href="#target16">• 제16조(이용자의 의무)</a>
		<a href="#target17">• 제17조(개인정보 유출 등에 대한 조치)</a>
		<a href="#target18">• 제18조(개인정보 유출 등에 대한 조치의 예외)</a>
		<a href="#target19">• 제19조(개인정보 자동 수집 장치의 설치·운영 및 거부에 관한 사항)</a>
		<a href="#target20">• 제20조(쿠키 설치 허용 지정 방법)</a>
		<a href="#target21">• 제21조(회사의 개인정보 보호 책임자 지정)</a>
		<a href="#target22">• 제22조(권익 침해에 대한 구제 방법)</a>
		<a href="#target23">• 부칙</a>
	</div>
	
	<ul>
		<li>
			<h4 id="target1">• 제1조(목적)</h4>
			스마트도서관(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.
		</li>
		<li>
			<h4 id="target2">• 제2조(개인정보 처리의 원칙)</h4>
		...
		<li>
			<h4 id="target5">• 제5조(회원 가입을 위한 정보)</h4>
			회사는 이용자의 회사 서비스에 대한 회원가입을 위하여 다음과 같은 정보를 수집합니다. <br>
			1. 필수 수집 정보: 이메일 주소, 비밀번호, 이름, 생년월일 및 휴대폰 번호 <br>
			2. 선택 수집 정보: 프로필 사진, 주소 <br>
		</li>
		<li>
			<h4 id="target6">• 제6조(본인 인증을 위한 정보)</h4>
			회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다. <br>
			1. 필수 수집 정보: 휴대폰 번호 및 이메일 주소
		</li>
		<li>
			<h4 id="target7">• 제7조(개인정보 수집 방법)</h4>
		...
		<li>
			<h4 id="target9">• 제9조(개인정보의 보유 및 이용기간)</h4>
		...
		<li>
			<h4 id="target10">• 제10조(법령에 따른 개인정보의 보유 및 이용기간)</h4>
		...
		<li>
			<h4 id="target15">• 제15조(아동의 개인정보보호)</h4>
		...
		<li>
			<h4 id="target16">• 제16조(이용자의 의무)</h4>
		...
		<li>
			<h4 id="target17">• 제17조(개인정보 유출 등에 대한 조치)</h4>
		...
		<li>
			<h4 id="target20">• 제20조(쿠키 설치 허용 지정 방법)</h4>
	...
	<div class="copyright">
		<p style="margin-top: 40px;">Copyright &copy; 2025 SMARTLIBRARY. All rights reserved.</p>
	</div>
</main>
